...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Please enter a c_name.";
    } else{
        // Prepare a select statement
        $sql = "SELECT c_id FROM courses WHERE c_name = ?";
    ...
    if(empty($username_err)){
        ...
        $sql = "DELETE FROM courses WHERE c_name=?";
...
<div class="sDivider col-md-6 index0" data-colsize="6" data-title="Column" style="padding-left: 400px;width: 70%">
 ...
 <h2 style="padding-bottom: 0px;font-size:27px;padding-left: 70px;">Enter course name to be deleted</h2>
    <div class="wrapper">
