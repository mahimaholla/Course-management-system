...
<div   class="form-group"  style="padding-top: 20px;padding-left: 500px;">
    ...
    <a class="btn btn-link" href="admin-stream-update.php">update</a>
 <a class="btn btn-link" href="admin_home.php">back</a>
</div>



<div style="font-family:Times New Roman;font-size: 30px;padding-left: 230px;padding-top: 10px;">Streams</div>
...
<table  width="800" border="1" align="center" style="width:50%;">
  ...
  padding: 10px 15px;"scope="col">Stream name</td>
