...
<div style="padding-top: 20px;padding-left: 150px; padding-bottom: 0px;"><p  style="color: #000;font-size: 45px;">Choose one Stream</p></div>
...
<div class="sDivider col-md-4 index2" data-colsize="4" data-title="Column"></div></div><div class="row simblaEL rDivider" data-drag="P5" id="P5" data-title="Row" style="position: relative; padding-top: 5px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">

    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P4" id="P4" href="pg-ug-science.php">
        
<?php  

 require_once "config.php";

 $sql = "SELECT S_name FROM  stream where s_id=1";
...
<div class="sDivider col-md-4 index2" data-colsize="4" data-title="Column"></div></div><div class="row simblaEL rDivider" data-drag="P5" id="P5" data-title="Row" style="position: relative; padding-top: 21px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">

    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P7" id="P7" href="pg-ug-commerse.php">
...
<?php  
 ...
 $sql = "SELECT S_name FROM  stream where s_id=2";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
...
<div class="row simblaEL rDivider" data-drag="P6" id="P6" data-title="Row" style="position: relative; padding-top: 21px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">
    ...
    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P8" id="P8" href="pg-ug-arts.php">

<?php  

 require_once "config.php";

 $sql = "SELECT S_name FROM  stream where s_id=3";
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
...
</div><div class="sDivider col-md-4 index2" data-colsize="4" data-title="Column"></div></div></div></div></div></div>
