...
<div   class="form-group"  style="padding-top: 20px;padding-left: 300px;">
          
    <a class="btn btn-link" href="admin-course-insert.php">Insert New courses</a>


    <a class="btn btn-link" href="admin-course-update.php">update</a>

     <a class="btn btn-link" href="admin-course-delete.php">Delete</a>
 <a class="btn btn-link" href="admin_home.php">back</a>
</div>


<div style="padding-top: 20px;padding-left: 320px; padding-bottom: 00px;">
    <p  style="color: #000;font-size: 30px;">courses</p></div> 
...
<table  width="800" border="1" align="center" style="width:50%;">
  ...
  padding: 10px 15px;" scope="col">sp_ID</td>
                        <td style="border: 3px solid #000;
  padding: 10px 15px;"scope="col">c_id</td>
                        <td style="border: 3px solid #000;
  padding: 10px 15px;"scope="col">c_name</td>
                        <td style="border: 3px solid #000;
  padding: 10px 15px;"scope="col">Year</td>
                      </tr>
...
<div class="form-group"  style="padding-top: 100px;padding-left: 600px;"        >
    <a class="btn btn-link" href="admin_home.php">back</a>
            </div>
