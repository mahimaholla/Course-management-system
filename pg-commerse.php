...
<div style="padding-top: 20px;padding-left: 260px; padding-bottom: 00px;">
    <p  style="color: #000;font-size: 30px;">PG Commerce courses</p></div> 
...
<?php  
 ...
 $sql = "SELECT c_name,year FROM courses where sp_id=22";
...
<div class="form-group"  style="padding-top: 100px;padding-left: 600px;"        >
    <a class="btn btn-link" href="pg-ug-commerse.php">back</a>
            </div>
