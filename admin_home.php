...
<div style="padding-top: 00px;padding-left: 120px; padding-bottom: 00px;"><p  style="color: #000;font-size: 30px;">Select a table to perform operations</p></div> 

<div class="row simblaEL rDivider" data-drag="P6" id="P6" data-title="Row" style="position: relative; padding-top: 21px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">

    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P8" id="P8" href="admin-editing-admin.php">Admin </a>
    
</div><div class="sDivider col-md-4 index2" data-colsize="4" data-title="Column"></div></div>



<div class="row simblaEL rDivider" data-drag="P2" id="P2" data-title="Row" style="position: relative; padding-top: 21px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">


    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P4" id="P4" href="admin-editing-user.php">Users</a>
...
<div class="row simblaEL rDivider" data-drag="P5" id="P5" data-title="Row" style="position: relative; padding-top: 21px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">

    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P7" id="P7" href="admin-editing-streams.php">Stream</a>
...
<div class="row simblaEL rDivider" data-drag="P6" id="P6" data-title="Row" style="position: relative; padding-top: 21px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">
    ...
    <a type="submit" class="simblaEL btn btn-lg btn-block" data-drag="P8" id="P8" href="admin-editing-specifications.php">Specification </a>
...
<div class="row simblaEL rDivider" data-drag="P6" id="P6" data-title="Row" style="position: relative; padding-top: 21px;padding-bottom: 100px;"><div class="sDivider col-md-4 index0" data-colsize="4" data-title="Column"></div><div class="sDivider col-md-4 index1" data-colsize="4" data-title="Column">

    <a type="submit" href="admin-editing-courses.php" class="simblaEL btn btn-lg btn-block" data-drag="P8" id="P8"> Courses </a>
