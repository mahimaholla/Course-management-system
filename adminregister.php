...
<div class="sDivider col-md-6 index0" data-colsize="6" data-title="Column" style="padding-left: 400px;width: 75%">
    ...
    <div class="wrapper">
    <form class="simblaEL" data-drag="P15" onsubmit="return simblaFormSubmit(this)" method="POST" id="P15" data-title="Form" name="" data-failure="" data-failure-type="text" data-success="" data-success-type="text"   style="width: 90%; padding-left: 100px;

padding-top: 50px;">
<div class="wrapper">
        <h2 style="color:#0BAE7C; ">Admin register</h2>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>
                <div  style="padding-top: 15px; " ></div>  <p style="font-size:18px;">Dont want to register? 

                <a style="background: #0BAE7C;
               border:1px; border-style:groove; border-color: #fff; color: #fff; padding: 8px; font-family:Franklin Gothic; font-size:15px; font-style: bold;" 
                 href="adminlogin.php">CANCLE </a></p>
