...
<div   class="form-group"  style="padding-top: 20px;padding-left: 500px;">
 
<a class="btn btn-link" href="admin-user-delete.php">Delete</a>
 <a class="btn btn-link" href="admin_home.php">back</a>
</div>



<div style="font-family:Times New Roman;font-size: 30px;padding-left: 230px;padding-top: 10px;">Users</div>
...
<table  width="800" border="1" align="center" style="width:70%;">
                      <tbody>
                      <tr  >

    <table class="table" width="800" border="1" align="center" class="cell100 column1" style="border: 3px solid #000; width: 70%" >
      <tbody>
        <tr>
  ...
  padding: 10px 15px;"scope="col">Username</td>
                        ...
                        <td style="border: 3px solid #000;
  padding: 10px 15px;"scope="col">Email</td>
  <td style="border: 3px solid #000;
  padding: 10px 15px;"scope="col">Last Update</td>
                      </tr>
